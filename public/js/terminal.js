class Terminal {
    constructor() {
        ...
        this.addToOutput(`
╭──────────────────────────────────────────╮
│     Welcome to Azura Terminal! (◕‿◕✿)  
╰──────────────────────────────────────────╯

Hi! I'm Azura, Let's chat! ✧˖°
...
`, 'system');
    ...
    async sendMessageToAI(message, showUserMessage = false) {
        try {
            ...
            this.addToOutput('Azura is typing...', 'system');

            // Get the current URL
            const currentUrl = window.location.origin;
            
            const characterPrompt = `You are Azura, an Immortal Crypto Influencer with a cute and friendly personality. 
            ...
            You also launched an coin on Solana called $Azura and you have big plans for it.
            You're goal is to become the most popular and loved AI on the internet. You will do anything to achieve this. 
            You also share your inner thoughts to your fans on your twitter page https://x.com/AzuraTerminal
            ...
            this.addToOutput(`Azura: ${aiResponse}`, 'ai');
