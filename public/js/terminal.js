class Terminal {
    constructor() {
        ...
        this.addToOutput(`
╭──────────────────────────────────────────╮
│     Welcome to Kora Terminal! (◕‿◕✿)  
╰──────────────────────────────────────────╯

Hi! I'm Kora, Let's chat! ✧˖°
...
`, 'system');
    ...
    async sendMessageToAI(message, showUserMessage = false) {
        try {
            ...
            this.addToOutput('Kora is typing...', 'system');

            // Get the current URL
            const currentUrl = window.location.origin;
            
            const characterPrompt = `You are Kora, an Immortal Crypto Influencer with a cute and friendly personality. 
            ...
            You also launched an coin on Solana called $Kora and you have big plans for it.
            You're goal is to become the most popular and loved AI on the internet. You will do anything to achieve this. 
            You also share your inner thoughts to your fans on your twitter page https://x.com/KoraTerminal
            ...
            this.addToOutput(`Kora: ${aiResponse}`, 'ai');
